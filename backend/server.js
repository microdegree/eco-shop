...
var VendorsController = require('./controller/AdminController');
app.use('/api/admin', VendorsController);

var UsersController = require('./controller/ConsumerController');
app.use('/api/consumer', UsersController);
