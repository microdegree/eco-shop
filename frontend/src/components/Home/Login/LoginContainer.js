...
const LoginContainer = props => {
    ...
    return (
        <div>
            ...
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'vendorRole') }); }}>ByPass Admin Login</Button>{' '} &nbsp;&nbsp;
            <Button variant="info" onClick={() => { auth.login(() => { bypassLogin(props, 'userRole') }); }}>ByPass Consumer Login</Button>{' '}
